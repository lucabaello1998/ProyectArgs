<?php
  ...
  mysqli_query($conn, "UPDATE mensajes_tec set visto = 'SI' WHERE token_sesion = '$token_sesion' AND quien <> '$quien_notas'");
?>
          ...
          <div class="row justify-content-center p-1">
            <div class="col-12 m-2">
                <form onsubmit="enviar_consulta(); return false" id="formconsul">
                  ...
                  <input type="hidden" name="token_sesion" value="<?php echo $token_sesion; ?>">
                  <label for="input_msj">Mensaje:</label>
                  <div class="input-group mb-3">
                    <!-- <div class="input-group-prepend" style="width: 2.5rem;">
                      <input type="file" class="form-control-file btn btn-outline-info" accept="image/*" name="imagen" id="envio_foto">
                    </div> -->
              ...
              <script>
                // Seleccionamos el input de archivos
                const inputFile = $('#envio_foto');
                // Al cambiar el valor del input de archivos
                inputFile.change(function() {

                  // Obtenemos el input de texto
                  const inputText = $('.input_msj');

                  // Deshabilitamos el input de texto
                  inputText.prop('readonly', true);
                  inputText.val('Archivo cargado');
                });
              </script>
              <script>
