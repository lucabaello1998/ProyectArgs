    ...
    <div class="row justify-content-center pr-2 pl-2 pt-2 pb-0">
      <div class="col-auto align-self-center p-0">
        <form action="../Guardar/save_fecha.php" method="POST">
          ...
          <input type="hidden" name="link" value="../Basico/mtto2.php">
  ...
  <div class="row pr-2 pl-2 pt-0 pb-0">
    <div class="container-fluid rounded bg-white shadow p-0">
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel" text-center>Carga de mtto</h5>
            ...
            <div class="modal-body">
              <form action="../Guardar/save_mtto.php" method="POST">
                <p class="h4 mb-4 text-center">Carga de mantenimiento</p>
                <div class="form-row">
                ...
                <div class="form-row border border-success p-1 mb-2">
                  ...
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="ont_mac" maxlength="50" class="form-control" placeholder="MAC ONT">
                  </div>
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="ont_sn" maxlength="50" class="form-control" placeholder="SN ONT">
                  </div>
                </div>
                ...
                <div class="form-row border border-info p-1 mb-2">
                  ...
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="stb_mac_uno" maxlength="50" class="form-control" placeholder="MAC STB 1">
                  </div>
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="stb_sn_uno" maxlength="50" class="form-control" placeholder="SN STB 1">
                  </div>
                </div>
                <div class="form-row border border-info p-1 mb-2">
                  <div class="col-12 align-self-center">
                  ...
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="stb_mac_dos" maxlength="50" class="form-control" placeholder="MAC STB 2">
                  </div>
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="stb_sn_dos" maxlength="50" class="form-control" placeholder="SN STB 2">
                  </div>
                </div>
                <div class="form-row border border-info p-1 mb-2">
                  <div class="col-12 align-self-center">
                  ...
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="stb_mac_tres" maxlength="50" class="form-control" placeholder="MAC STB 3">
                  </div>
                  <div class="form-group col-md-6 col-12 p-1 mb-0">
                    <input type="text" name="stb_sn_tres" maxlength="50" class="form-control" placeholder="SN STB 3">
                  </div>
                </div>
      ...
      <?php
        if($zona_us == 'Todo')
        {
          $altas_cont = mysqli_query($conn, "SELECT * FROM mtto WHERE fecha LIKE '%$mes%' AND completo = 'NO'");
        }
        else
        {
          $altas_cont = mysqli_query($conn, "SELECT * FROM mtto WHERE fecha LIKE '%$mes%' AND zona = '$zona_us' AND completo = 'NO'");
        }
      ...
      ?>
        <div class="row justify-content-center p-1">
          <div class="col-auto">
            <p class="h4 mb-4 text-center">Mantenimientos pendientes (<?php echo $cont_pend; ?>)</p>
            <table class="table table-responsive table-striped table-bordered table-sm" style="max-height: 50rem;">
              ...
              <tbody>
                <?php
                  if($zona_us == 'Todo')
                  {
                   $altas = mysqli_query($conn, "SELECT * FROM mtto WHERE fecha LIKE '%$mes%' AND completo = 'NO' ORDER BY id asc");
                  }
                  else
                  {
                    $altas = mysqli_query($conn, "SELECT * FROM mtto WHERE fecha LIKE '%$mes%' AND zona = '$zona_us' AND completo = 'NO' ORDER BY id asc");
                  }
                ...
                ?>
                  <tr align="center">
                    ...
                    <td>
                      <a href="../Editar/edit_mtto2.php?id=<?php echo $row['id']; ?>">
                        <i class="fas fa-pen p-2"></i>
                      </a>
                    <?php if($tipo_us == 'Administrador') { ?>
                      <a class="text-danger" href="../Borrar/delete_mtto.php?id=<?php echo $row['id']?>">
                        <i class="far fa-trash-alt p-2"></i>
                      </a>
                    <?php } ?>
                    </td>
                    <td style="cursor: pointer;" class="toggler" data-prod-cat="<?php echo $row['id']?>"><?php echo $row['tecnico']; ?></td>
                    <td style="cursor: pointer;" class="toggler" data-prod-cat="<?php echo $row['id']?>"><?php echo $row['ot']; ?></td>
                    <td style="cursor: pointer;" class="toggler" data-prod-cat="<?php echo $row['id']?>"><?php echo $row['direccion']; ?></td>
                    <td style="cursor: pointer;" class="toggler" data-prod-cat="<?php echo $row['id']?>"><?php echo $row['zona']; ?></td>
                    <td style="cursor: pointer;" class="toggler" data-prod-cat="<?php echo $row['id']?>"><?php echo Fecha7($row['fecha']); ?></td>
                  </tr>
                  <tr hidden><td></td></tr>
                  <tr class="cat<?php echo $row['id'];?>" style="display:none">
                      ...
                      <div class="row p-2">
                        <?php if($row['ont_mac'] !== ''){ ?>
                          <div class="col border border-success p-2">
                            <h6>ONT</h6>
                              <p class="m-1"><b>MAC:</b> <?php echo $row['ont_mac']; ?></p>
                              <p class="m-1"><b>SN:</b> <?php echo $row['ont_sn']; ?></p>
                          </div>
                        <?php } ?>
                        <?php if($row['stb_mac_uno'] !== ''){ ?>
                          <div class="col border border-info p-2">
                            <h6>STB 1</h6>
                              <p class="m-1"><b>MAC:</b> <?php echo $row['stb_mac_uno']; ?></p>
                              <p class="m-1"><b>SN:</b> <?php echo $row['stb_sn_uno']; ?></p>
                          </div>
                        <?php } ?>
                        <?php if($row['stb_mac_dos'] !== ''){ ?>
                          <div class="col border border-info p-2">
                            <h6>STB 2</h6>
                              <p class="m-1"><b>MAC:</b> <?php echo $row['stb_mac_dos']; ?></p>
                              <p class="m-1"><b>SN:</b> <?php echo $row['stb_sn_dos']; ?></p>
                          </div>
                        <?php } ?>
                        <?php if($row['stb_mac_tres'] !== ''){ ?>
                          <div class="col border border-info p-2">
                            <h6>STB 3</h6>
                              <p class="m-1"><b>MAC:</b> <?php echo $row['stb_mac_tres']; ?></p>
                              <p class="m-1"><b>SN:</b> <?php echo $row['stb_sn_tres']; ?></p>
                          </div>
                        <?php } ?>
                      </div>
                    </td>
      ...
      <?php } else { ?>
        <div class="row justify-content-center p-1">
          <div class="col-auto">
            <p class="h5 mb-4 text-center">No hay mtto pendientes</p>
          </div>
        </div>
      <?php } ?>
      ...
      <div class="row justify-content-center p-1">
        <div class="col-auto">
          <p class="h4 mb-4 text-center">Mantenimientos completos</p>
          <table class="table table-responsive table-striped table-bordered table-sm" style="max-height: 50rem;">
            <thead class="thead-dark text-center">
              <tr>
                <th>Estado</th>
            ...
            <tbody>
              <?php
                if($zona_us == 'Todo')
                {
                  $altas_b = mysqli_query($conn, "SELECT * FROM mtto WHERE fecha LIKE '%$mes%' AND completo = 'SI' ORDER BY id desc");
                }
                else
                {
                  $altas_b = mysqli_query($conn, "SELECT * FROM mtto WHERE fecha LIKE '%$mes%' AND zona = '$zona_us' AND completo = 'SI' ORDER BY id desc");
                }
