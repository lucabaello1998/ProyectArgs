  ...
  var borrar = '<i class="far fa-trash-alt p-2"></i>';
    $(document).ready(function()
        ...
        { 
          ...
          "buttons":
                [ //'columnsToggle'///
                  {
                    ...
                    autoFilter: false,
                    titleAttr: 'Imprimir altas',                  
                    className: 'btn btn-info',
                  },
                  {
                    extend: 'excelHtml5',
                    text: '<i class="fas fa-file-excel"></i>',
                    titleAttr: 'Exportar altas a Excel',
                    autoFilter: false,
                    sheetName: 'Argentseal Altas',
                    title: 'Altas',
                  ...
                  },
                  {
                    ...
                    titleAttr: 'Exportar altas a PDF',
                    title: 'Altas',
                    download: 'open',
              ...
              "responsive": true,
                ...
                "processing": true,
                "serverSide": true,              
                "sAjaxSource": "../ServerSide/serversideAltas.php",
                "stateSave": true,
                "select":  true,
                "columnDefs":
                [{
        ...
        $('#example tbody').on( 'click', '#editar', function () {
          ...
          onclick (window.location.href='../Editar/edit.php?id='+data[0]);
        } ); 
        $('#example tbody').on( 'click', '#borrar', function () {
          var datab = table.row( $(this).parents('tr') ).data();              
          onclick (window.location.href='../Borrar/delete_altas.php?id='+datab[0]);
        } );      
      });
</script>
  </body>
