          ...
          <table id="example" class="table table-responsive table-striped table-bordered display compact table-sm" cellspacing="0" style="width:100%">
            <thead class="thead-dark text-center">
              <tr>
                ...
                <th>Direccion</th>
                <th>Zona</th>
                <th>Fecha 1° reparacion</th>
                <th>OT</th>
                <th>Ultima Fecha</th>
                <th>Ultima OT</th>
                <th>Abonado</th>
                <th>1° motivo de cierre</th>
...
<script>
  ...
  $(document).ready(function()
        ...
        {           
          ...
          "buttons":
                ...
                
                {
                  ...
                  autoFilter: false,
                  titleAttr: 'Imprimir reincidencias',                  
                  className: 'btn btn-info',
                },
                {
                  extend: 'excelHtml5',
                  text: '<i class="fas fa-file-excel"></i>',
                  titleAttr: 'Exportar reincidencias a Excel',
                  autoFilter: false,
                  sheetName: 'Argentseal reincidencias',
                  title: 'Reincidencias',
                ...
                },
                {
                  ...
                  pdfName: 'Argentseal reincidencias',
                  titleAttr: 'Exportar reincidencias a PDF',
                  title: 'Reincidencias',
                  download: 'open',
                ...
                "language":
                {
                  ...
                  "info":           "Mostrando _START_ a _END_ de un total de _TOTAL_ reincidencias",
                  "infoEmpty":      "No hay reincidencias disponibles",
                  "infoFiltered":   "(filtrado de _MAX_ reincidencias)",
                ...
                "processing": true,
                "serverSide": true,              
                "sAjaxSource": "../ServerSide/serversideReincidencias.php",
                "stateSave": true,
                 "select":  true,
                "columnDefs":
                [{
        ...
        $('#example tbody').on( 'click', '#editar', function () {
          ...
          onclick (window.location.href='../Editar/edit_reincidencias.php?id='+data[0]);
        } );
        $('#example tbody').on( 'click', '#borrar', function () {
          var datab = table.row( $(this).parents('tr') ).data();              
          onclick (window.location.href='../Borrar/delete_reincidencias.php?id='+datab[0]);
        } );
