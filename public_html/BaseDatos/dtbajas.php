...
<div class="container-fluid p-4">
  <div class="row p-2">
    <div class="container-fluid rounded bg-white shadow p-2">

      <div class="row justify-content-center p-1">
        <div class="col-auto">
          <p class="h4 mb-4 text-center">Bajas cargadas</p>
          <div id="export" style="float:left" class="p-2"></div>
          <table id="example" class="table table-responsive table-striped table-bordered display nowrap compact table-sm" cellspacing="0" style="width:100%">
...
<script>
  ...
  $(document).ready(function()
    ...
    var table = $("#example").DataTable(
    {
        ...
        [
          {
            ...
            autoFilter: false,
            titleAttr: 'Imprimir bajas',
            className: 'btn btn-info',
          },
          {
            extend: 'excelHtml5',
            text: '<i class="fas fa-file-excel"></i>',
            titleAttr: 'Exportar bajas a Excel',
            autoFilter: false,
            sheetName: 'Argentseal Bajas',
            title: 'Bajas',
          ...
          },
          {
            ...
            titleAttr: 'Exportar bajas a PDF',
            title: 'Bajas',
            download: 'open',
      ...
      "processing": true,
      "serverSide": true,
      "sAjaxSource": "../ServerSide/serversideBajas.php",
      "select":  true,
      "columnDefs":
        [
          {
    ...
    table.buttons().container().appendTo($('#export'));
      $('#example tbody').on( 'click', '#editar', function () {
        ...
        onclick (window.location.href='../Editar/edit_bajas.php?id='+data[0]);
      } );
      $('#example tbody').on( 'click', '#borrar', function () {
        var datab = table.row( $(this).parents('tr') ).data();              
        onclick (window.location.href='../Borrar/delete_bajas.php?id='+datab[0]);
      } );
  });
</script>
</body>
