  ...
  <div class="row pr-2 pl-2 pt-0 pb-0">
    <div class="container-fluid rounded bg-white shadow p-0">
      ...
      <div class="row justify-content-center p-1 m-0">
        <div class="col-auto">
          <p class="h4 mb-4 text-center">Egresos</p>
  ...
  $(document).ready(function()
        ...
        {           
          ...
          "buttons":
                ...
                "processing": true,
                "serverSide": true,              
                "sAjaxSource": "../ServerSide/serversideEnmat.php",
                "stateSave": true,
                "select":  true,
                "columnDefs":
                [{
        ...
        $('#example tbody').on( 'click', '#editar', function () {
          ...
          onclick (window.location.href='../Editar/edit_herramienta_egreso.php?id='+data[0]);
        } );
        $('#example tbody').on( 'click', '#borrar', function () {
          var datab = table.row( $(this).parents('tr') ).data();              
          onclick (window.location.href='../Borrar/delete_entrega_material.php?id='+datab[0]);
        } );      
      });
    </script>
  </body>
