...
<script>
  $(document).ready(function()
        ...
        { 
          ...
          "buttons":
                [ //'columnsToggle'///
                {
                  ...
                  autoFilter: false,
                  titleAttr: 'Imprimir reclamos',                  
                  className: 'btn btn-info',
                },
                {
                  extend: 'excelHtml5',
                  text: '<i class="fas fa-file-excel"></i>',
                  titleAttr: 'Exportar reclamos a Excel',
                  autoFilter: false,
                  sheetName: 'Argentseal reclamos',
                  title: 'Reclamos',
                ...
                },
                {
                  ...
                  pdfName: 'Argentseal Altas',
                  titleAttr: 'Exportar reclamos a PDF',
                  title: 'Reclamos',
                  download: 'open',
              ...
              "responsive": true,
                "language":
                {
                  ...
                  "zeroRecords":    "No se encontro ningun reclamo",
                  "info":           "Mostrando _START_ a _END_ de un total de _TOTAL_ reclamos",
                  "infoEmpty":      "No hay reclamos disponibles",
                ...
                "processing": true,
                "serverSide": true,              
                "sAjaxSource": "../ServerSide/serversideReclamos.php",
                "stateSave": true,
                "select":  true,
                "columnDefs":
                [{
        ...
        $('#example tbody').on( 'click', 'button', function () {
          ...
          onclick (window.location.href='../Editar/edit_reclamos.php?id='+data[0]);
        } );        
      });
    </script>
  </body>
