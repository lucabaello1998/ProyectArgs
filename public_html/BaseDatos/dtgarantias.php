...
<script>
  ...
  $(document).ready(function()
        ...
        var table = $("#example").DataTable(
        {
          ...
          "buttons":
                ...
                "language":
                {
                  ...
                  "info":           "Mostrando _START_ a _END_ de un total de _TOTAL_ garantias",
                ...
                "processing": true,
                "serverSide": true,              
                "sAjaxSource": "../ServerSide/serversideGarantias.php",
                "stateSave": true,
                "select":  true,
                "columnDefs":
                [{
        ...
        $('#example tbody').on( 'click', '#editar', function () {
          ...
          onclick (window.location.href='../Editar/edit_garantias.php?id='+data[0]);
        } );
        $('#example tbody').on( 'click', '#borrar', function () {
          var datab = table.row( $(this).parents('tr') ).data();              
          onclick (window.location.href='../Borrar/delete_garantias.php?id='+datab[0]);
        } );
