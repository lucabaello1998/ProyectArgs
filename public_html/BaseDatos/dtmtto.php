  ...
  <div class="row pr-2 pl-2 pt-0 pb-0">
    <div class="container-fluid rounded bg-white shadow p-0">
      ...
      <div class="row justify-content-center p-1 m-0">
        <div class="col-auto">
          <p class="h4 mb-4 text-center">Mantenimientos cargados</p>
...
<script>
  $(document).ready(function()
        ...
        { 
          ...
          "buttons":
                [ //'columnsToggle'///
                {
                  ...
                  autoFilter: false,
                  titleAttr: 'Imprimir mtto',                  
                  className: 'btn btn-info',
                },
                {
                  extend: 'excelHtml5',
                  text: '<i class="fas fa-file-excel"></i>',
                  titleAttr: 'Exportar mtto a Excel',
                  autoFilter: false,
                  sheetName: 'Argentseal Mantenimientos',
              ...
              "responsive": true,
                ...
                "processing": true,
                "serverSide": true,              
                "sAjaxSource": "../ServerSide/serversideMtto.php",
                "stateSave": true,
                "select":  true,
                "columnDefs":
                [{
        ...
        $('#example tbody').on( 'click', 'button', function () {
          ...
          onclick (window.location.href='../Editar/edit_mtto.php?id='+data[0]);
        } );        
      });
    </script>
  </body>
