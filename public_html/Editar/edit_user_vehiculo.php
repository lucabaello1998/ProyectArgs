...
if  (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "SELECT * FROM vehiculo_user WHERE id=$id";
...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE vehiculo_user set vehiculo = '$vehiculo' WHERE id=$id";
      ...
      <div class="row justify-content-center p-1 m-0">
        <div class="col-auto">
          <div class="card card-body">
            <form action="edit_user_vehiculo.php?id=<?php echo $_GET['id']; ?>" method="POST">
              <p class="h4 mb-4 text-center">Actualizar vehiculo</p>
              <div class="form-row">
                <div class="form-group col">
                  <label for="exampleFormControlSelect1">Vehiculo</label >
                  <input type="text" name="vehiculo" class="form-control" value="<?php echo $vehiculo; ?>" autofocus>
                </div>
              </div>
