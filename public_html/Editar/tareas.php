...
<?php
  ...
  {
    $as = mysqli_query($conn, "SELECT * FROM tareas ORDER BY inicio desc LIMIT 1");  
    while($row = mysqli_fetch_assoc($as))
    {
      $ult_fecha = $row['inicio'];
    ...
    <div class="container-fluid rounded bg-white shadow p-0">
      ...
      <div class="row justify-content-center p-1">
        <div class="col-auto align-self-center p-2">
          <form action="../Guardar/save_tareas.php" method="POST">
            <input type="hidden" name="ultima_fecha" value="<?php echo $ultimo_mes; ?>">
            <button type="submit" name="menos" class="btn btn-dark p-2 m-2 otro_mes" data-toggle="tooltip" data-placement="bottom" title="Mes anterior">
              <i class="fa-solid fa-caret-left"></i>
            </button>
          </form>
        </div>
        <div class="col-auto align-self-center p-2 text-center">
          <span class="h4">Tareas de <?php echo Fecha10($ultimo_mes); ?></span>
        </div>
        <div class="col-auto align-self-center p-2">
          <form action="../Guardar/save_tareas.php" method="POST">
            <input type="hidden" name="ultima_fecha" value="<?php echo $ultimo_mes; ?>">
            <button type="submit" name="mas" class="btn btn-dark p-2 m-2 otro_mes" data-toggle="tooltip" data-placement="bottom" title="Mes siguiente">
                  ...
                  <div class="form-row" id="tabla">
                    <div class="col-md-12 p-1 m-1 fila-fija" id="pepe">
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" required name="item[]" id="item" placeholder="Ingresar subtarea" aria-label="Ingresar subtarea" aria-describedby="button-addon2">
                      ...
                      <div class="form-row">
                        <div class="col-md-12 p-2">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="imagen1" lang="es" name="imagen1">
                            <label class="custom-file-label" for="imagen1">Subir 1° archivo</label>
                          </div>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col-md-12 p-2">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="imagen2" lang="es" name="imagen2">
                            <label class="custom-file-label" for="imagen2">Subir 2° archivo</label>
                          </div>
                        </div>
                      </div>
                      <div class="form-row">
                        <div class="col-md-12 p-2">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="imagen3" lang="es" name="imagen3">
                            <label class="custom-file-label" for="imagen3">Subir 3° nom_archivo_uno</label>
                          </div>
                        </div>
                      </div> 
                    </div>
      ...
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-tablero" role="tabpanel" aria-labelledby="nav-tablero-tab">
          ...
          <div class="row justify-content-center">
            <?php
              $estados = mysqli_query($conn, "SELECT * FROM tareas WHERE mensaje = '' GROUP BY estado ORDER BY id asc");
                ...
                <div class="card bg-white rounded shadow-sm">
                  ...
                  <div class="card-body p-1">
                    <div class="accordion" id="accordionExample">
                      <?php
                          $pen = mysqli_query($conn, "SELECT *, COUNT(estado) as 'tareas_pendientes' FROM tareas WHERE estado = '$estado' AND inicio LIKE '%$ultimo_mes%' AND mensaje = '' GROUP BY tarea ORDER BY id desc");
                        ...
                        <div class="card-header shadow-sm bg-white m-1 p-1">
                          <div class="collapsed p-1 m-1" type="button" data-toggle="collapse" data-target="#<?php echo $abrev_token.$color_estado; ?>">
                            <div class="row p-1">
                              <div class="col-12">
                                <span><?php echo utf8_decode($row['tarea']); ?></span>
                              </div>
                            </div>
                        ...
                        <?php 
                          $pendi = mysqli_query($conn, "SELECT * FROM tareas WHERE estado = '$estado' AND abreviado = '$abrev_token' AND inicio LIKE '%$ultimo_mes%' AND mensaje = '' ORDER BY id desc");
                                  ...
                                  <form action="../Guardar/save_tareas.php?actualizar=<?php echo $roww['token']; ?>" method="POST">
                                    ...
                                    <div class="modal-body">
                                      <div class="form-row">
                                        <div class="form-group col-md-4 col-12">
                                          <label>Titulo breve</label>
                                          <input type="text" name="titulo" class="form-control" value="<?php echo utf8_decode($roww['titulo']); ?>">
                                        </div>
                                        <div class="form-group col-md-4 col-6">
                                          <label>Tipo</label >
                                      ...
                                      <div class="form-row">
                                        <div class="col-md-12 p-2">
                                          <label>Descripcion</label>
                                          <textarea type="text" name="descripcion" class="form-control"><?php echo utf8_decode($roww['descripcion']); ?></textarea>
                                        </div>													
                                      </div>
                                      <div class="form-row">
                                        <div class="col-md-12 p-2">
                          ...
                          <!-- Modal tarea -->
                            <div class="modal fade" id="<?php echo $token_tarea; ?>" tabindex="-1" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title h5"><?php echo utf8_decode($roww['titulo']); ?></h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                    <div class="row p-1">
                                      <div class="col-12 p-2">
                                        ...
                                        <p class="ml-4"><?php echo utf8_decode($roww['quien']); ?></p>
                                      </div>
                                    </div>
                                    <div class="row p-1">
                                      <div class="col-12 p-2">
                                    ...
                                    <div class="row p-1">
                                      <div class="col-12 p-2">
                                        ...
                                        <p class="ml-4"><?php echo utf8_decode($roww['a_quien']); ?></p>
                                      </div>
                                    </div>
                                    <div class="row p-1">
                                      <div class="col-12 p-2">
                                        <p class="h6 text-muted">Descripcion:</p> 
                                        <p class="ml-4"><?php echo utf8_decode($roww['descripcion']); ?></p>
                                      </div>
                                    </div>
                                    <div class="row p-1">
                                      <div class="col-12 p-2">
                                    ...
                                    <?php if ($roww['archivo_uno'] !== '' || $roww['archivo_dos'] !== '' || $roww['archivo_tres'] !== '') { ?>
                                      <div class="row p-1">
                                        ...
                                        <?php if ($roww['archivo_uno'] !== ''){ ?>
                                          <div class="col-4 p-2">
                                            <a href="../Archivos/tareas/<?php echo $row['archivo_uno']; ?>" download="<?php echo $row['archivo_uno']; ?>"><i class="fas fa-file-download"></i><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></a>
                                          </div>
                                        <?php } ?>
                                        <?php if ($roww['archivo_dos'] !== ''){ ?>
                                          <div class="col-4 p-2">
                                            <a href="../Archivos/tareas/<?php echo $row['archivo_dos']; ?>" download="<?php echo $row['archivo_dos']; ?>"><i class="fas fa-file-download"></i><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></a>
                                          </div>
                                        <?php } ?>
                                        <?php if ($roww['archivo_tres'] !== ''){ ?>
                                          <div class="col-4 p-2">
                                            <a href="../Archivos/tareas/<?php echo $row['archivo_tres']; ?>" download="<?php echo $row['archivo_tres']; ?>"><i class="fas fa-file-download"></i><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></a>
                                          </div>
                                        <?php } ?>
                                      </div>
                                    <?php } ?>
          ...
          <div class="row justify-content-center p-1">
            <div class="col-auto">
              ...
              <table class="table table-responsive table-striped table-bordered table-sm">
                ...
                <tbody align="center">
                  <?php
                    $result_tasks = mysqli_query($conn, "SELECT * FROM tareas WHERE mensaje = '' AND inicio LIKE '%$ultimo_mes%' AND quien = '$quien_notas' OR mensaje = '' AND inicio LIKE '%$ultimo_mes%' AND a_quien LIKE '%$quien_notas%' ORDER BY id desc LIMIT 10");
                  ...
                  ?>
                    <tr>
                                    ...
                                    <form action="../Guardar/save_tareas.php?actualizar=<?php echo $row['token']; ?>" method="POST">
                                      ...
                                      <div class="modal-body">
                                        <div class="form-row">
                                          <div class="form-group col-md-4 col-12">
                                            <label>Titulo breve</label>
                                            <input type="text" name="titulo" class="form-control" value="<?php echo utf8_decode($row['titulo']); ?>">
                                          </div>
                                          <div class="form-group col-md-4 col-6">
                                            <label>Tipo</label >
                                            <select type="text" name="tarea" class="form-control">
                                        ...
                                        <div class="form-row">
                                          <div class="col-md-12 p-2">
                                            <label>Descripcion</label>
                                            <textarea type="text" name="descripcion" class="form-control"><?php echo utf8_decode($row['descripcion']); ?></textarea>
                                          </div>													
                                        </div>
                                      </div>
                                      <div class="modal-footer">
                      ...
                      <td><span class="badge <?php echo $color_tarea; ?>"><?php echo $row['estado']; ?></span></td>
                      <td><?php echo $row['prioridad']; ?></td>
                      <td><?php echo utf8_decode($row['quien']); ?></td>
                      <td><?php echo utf8_decode($row['tarea']); ?></td>
