  ...
  <div class="row p-2">
    <div class="container-fluid rounded bg-white shadow p-0">
      ...
      <div class="row justify-content-center p-1 m-0">
        <div class="col-auto">
          <form action="edit2.php?act=<?php echo $_GET['id']; ?>" method="POST">
            ...
            <div class="form-row border border-info p-1 mb-2">
              ...
              <div class="form-group col-md-6 col-12 p-1 mb-0">
                <input type="text" name="sn_dos_stb" class="form-control" maxlength="50" value="<?php echo $sn_dos_stb; ?>" placeholder="SN STB 2">
              </div>
            </div>
            <div class="form-row border border-info p-1 mb-2">
              <div class="col-12 align-self-center">
