...
<div class="container">
  ...
  <h4 class="modal-title" text-center>Formulario de Edicion de Tareas</h4>
</div>
        ...
        <form action="../Guardar/save_tareas.php" method="POST" data-toggle="validator">
          ...
          <p class="h4 mb-4 text-center">Carga de Tareas </p>
            ...
            <div class="form-row">
              ...
              <input type="text" name="FECHA" class="form-control" autofocus required>
            </div>
            <div class="form-row">         
