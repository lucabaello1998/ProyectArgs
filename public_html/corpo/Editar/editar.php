        ...
        <form action="editar.php?id=<?php echo $_GET['id']; ?>" method="POST">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" name="CERTIFICACION" class="form-control" value="<?php echo $CERTIFICACION; ?>" placeholder="Actualice el CERTIFICACION" autofocus>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
