...
<div class="container">
  ...
  <h4 class="modal-title" text-center>Borrar Tareas Realizadas</h4>
</div>
      ...
      <div class="col-5 col-sm-5">
        <div class="row justify-content-end p-1 pr-3">
          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#alta">
            Borrar <i class="fa-solid fa-angle-up"></i>
          </button>
        </div>       
    </div>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" text-center>Formulario Borrado </h5>
      ...
      <div class="card card-body">
        <form action="../Guardar/save_bajas.php" method="POST" data-toggle="validator">
          ...
          <p class="h4 mb-4 text-center">Borrar Tareas</p>
...
<div class="container-fluid p-2 p-md-5 p-sm-3">
  <div class="row align-items-start justify-content-center">
    <div class="col-12">
      <p class="h4 mb-4 text-center">Altas cargadas</p>
