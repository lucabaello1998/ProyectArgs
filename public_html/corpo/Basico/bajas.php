...
<div class="container">
  ...
  <h4 class="modal-title" text-center>Carga de Formulariode Bajas</h4>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" text-center>Carga de Tareas de Bajas </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="card card-body">
        <form action="../Guardar/save_bajas.php" method="POST" data-toggle="validator">

          <p class="h4 mb-4 text-center">Carga de Tareas de Baja</p>
...
<div class="container-fluid p-2 p-md-5 p-sm-3">
  <div class="row align-items-start justify-content-center">
    <div class="col-12">
      <p class="h4 mb-4 text-center">Bajas cargadas</p>
      ...
      <table class="table table-responsive table-striped table-bordered table-sm">
        ...
        <tbody align="center">
          <?php
          $query = "SELECT * FROM corpo WHERE tarea = 'Baja'  ORDER BY ID DESC"; /* CONSULTA EDITADA "WHERE INICIOtareas[columna de la tabla donde aplicar filtro] = 'Alta'" */ /* "CLIENTE descendiente" ORDER BY CERTIFICACION[columna en cual CLIENTEar] DESC  */
          $result_tasks = mysqli_query($conn, $query);    

          while($row = mysqli_fetch_assoc($result_tasks)) { ?>
            <tr>
              <td>
                <a href="../Editar/editar_tarea.php?id=<?php echo $row['id']?>">
  ...
  <div class="row align-items-start justify-content-center">
              ...
              <a class="btn btn-info" role="button">Ver todas las altas</a>             
