	...
	$body .="<table>";  /////tabla estructura
			$body .="<td>"; //////segunda columna
				...
				$body .="</tr>";      //////fin encabezado  
						...
						$query = "SELECT SUM(cantidad) as 'todos', (cantec*'$tectectec') as 'restos', material, cantec, centro FROM materiales WHERE 'todos' < (cantec*'$tectectec') GROUP BY material";
