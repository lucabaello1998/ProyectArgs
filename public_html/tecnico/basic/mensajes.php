...
<?php
  if($tipo_us == 'Tecnico')
  {
    mysqli_query($conn, "UPDATE mensajes_tec set visto = 'SI' WHERE quien <> '$quien_notas' AND tecnico = '$quien_notas' AND estado = 'Abierto' ");
  }
?>
        ...
        <div class="container-fluid rounded bg-white shadow p-0">
          ...
          <div class="row justify-content-center p-1">
            <div class="col-auto">
              ...
              ?>
                <p class="h5 text-center">Continuar con chat abierto</p>
                <div class="row">
              ...
              <?php
                ...
                {
              ?>
                <p class="h5 text-center">Iniciar nuevo chat</p>
              <?php } ?>
            </div>
          </div>
          <br>
          <div class="row justify-content-center p-1">
            <div class="col-12 m-2">
                <form onsubmit="enviar_consulta(); return false" id="formconsul">
                  <input type="hidden" name="quien" value="<?php echo $quien_consultas; ?>">
              ...
              <script>
                setInterval(function(){
                  $(document).ready(function(){
                    $('#consulta_msj').load('../ajax/consultas.php')
                  });
                },5000);
              </script>
              <script>
