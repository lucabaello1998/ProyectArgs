          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <!-----VISTA DESPACHO---->
                ...
                <a class="dropdown-item" href="../Basico/ingresomaterial.php">Ingreso</a>            
                <a class="dropdown-item" href="../Basico/analisis_materiales.php">Materiales</a>
                <a class="dropdown-item" href="../Basico/devolucionn.php">Devolucion</a>
                <?php } ?>
              <!-----VISTA DESPACHO---->
              <!-----VISTA SUPERVISOR---->
          ...
          <li class="nav-item dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <!-----VISTA ADMINISTRADOR---->
                ...
                <a class="dropdown-item" href="../Basico/altas2.php">Altas 2</a>
          ...
          <div class="col-2 col-md-4">
            <!------BAJAS Y RECLAMOS------->
              <div class="<?php if ($notitotal>=1){echo "dropdown";}else{echo "";} ?>">
                <a class="nav-link text-white <?php if ($notitotal>=1){echo "dropdown-toggle";}else{echo "";} ?>  justify-content-between" href="#" id="noti" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="col-2 col-md-4 ml-2">
            <!------VEHICULOS------->
              <div class="<?php if ($notivehiculototal>=1){echo "dropdown";}else{echo "";} ?>">
                <a class="nav-link text-white <?php if ($notivehiculototal>=1){echo "dropdown-toggle";}else{echo "";} ?>  justify-content-between" href="#" id="notivehiculo" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php if ($tipo_us == 'Administrador' || $tipo_us == 'Despacho'){ ?>
                  ...
                  <?php if($nombre == 'Damian' && $apellido == 'Duarte'){ ?>
                    <div class="form-row justify-content-center">
                      <a href="../../tecnico/index.php" class="h1 text-warning"><i class="fa-solid fa-people-arrows"></i></a>
                    </div>
                  <?php } ?>
                  <div class="dropdown-divider"></div>
                <?php } ?>
