...
if(isset($_GET['id'])) {
	$id = $_GET['id'];
	$query_img = "SELECT * FROM auditoria WHERE id=$id";
  ...
  $filename1 = "../Archivos/herramientas/$imagenprimera";
  if (file_exists($filename1))
  {
    $success = unlink($filename1);           
  }
  $filename2 = "../Archivos/herramientas/$imagensegunda";
  if (file_exists($filename2))
  {
    $success = unlink($filename2);           
  }
  $filename3 = "../Archivos/herramientas/$imagentercera";
  if (file_exists($filename3))
  {
    $success = unlink($filename3);           
  }
  $filename4 = "../Archivos/herramientas/$imagencuarta";
